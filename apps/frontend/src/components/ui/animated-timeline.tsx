/*
 * Animated Timeline — Animata
 * https://animata.design/docs/progress/animatedtimeline
 *
 * Une frise verticale : des ronds reliés par un trait. Les étapes jusqu'à
 * l'étape « active » sont allumées ; au survol d'une étape, les ronds et le
 * trait se remplissent en cascade jusqu'à elle.
 *
 * Retouche InteriMatch : le fond des ronds éteints utilisait
 * hsl(var(--background)), qui ne marche pas avec nos couleurs oklch → remplacé
 * par var(--surface).
 */
"use client";
...
const TimelineItem: React.FC<TimelineItemProps> = ({
  ...
  const dotStyle: React.CSSProperties = {
    ...
    backgroundColor: isDotActive ? styles.activeDotColor : "var(--surface)",
